...
<link rel="stylesheet" type="text/css" href="/social/css/kingdom.css">
<script type="text/javascript" src="/social/js/jquery.js"></script>
<script type="text/javascript" src="/social/js/info.js"></script>
		...
		$('.member').click(function(){
			...
			*/
			...
			$('#infoContainer').stop().slideUp(200, function(){
				...
				$.ajax({
					url: '/social/member/memberInfo.cnu',
					type: 'POST',
					dataType: 'json',
					data: {
						mno: sno
					...
					success: function(obj){
						...
						$('#id').text(obj.id);
						$('#mail').text(obj.mail);
						var gender = obj.gen == 'M'? '남 자' : '여 자';
						$('#gen').text(gender);
						$('#jdate').text(obj.sdate);
						$('#avt').attr('src', '/social/img/avatar/' + obj.avatar);
...
<body>
	<form method="POST" action="/social/member/memberInfo.cnu" id="frm">
			...
			<div id="leave" class="w3-modal" style="display: none;">
	  		<div class="w3-modal-content">
				    ...
				    <div class="w3-container w3-margin-top w3-margin-bottom">
						<form method="POST" action="/social/member/memberDel.cnu" 
								id="dfrm" name="dfrm"
								class="w3-col w3-padding w3-margin-bottom">
							<input type="hidden" name="mno" id="mno2">
							<h2 class="w3-container w3-center w3-padding">social을 탈퇴하시겠습니까?</h2>
